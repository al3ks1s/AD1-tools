...
void arbitrary_read(ad1_session* session, char* buf, unsigned long length, unsigned long offset);

void arbitrary_read_string(ad1_session* session, char* buf, int length, unsigned long offset);
